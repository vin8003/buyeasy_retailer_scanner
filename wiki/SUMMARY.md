...
* [Apps and links](getting-started/apps-and-links.md)
* [Getting started — customers](getting-started/for-customers.md)
* [Getting started — retailers](getting-started/for-retailers.md)

## Customer guide

* [Customer guide overview](customer-guide/README.md)
...
* [Rewards and referrals](customer-guide/rewards-and-referrals.md)
* [Your account](customer-guide/your-account.md)

## Retailer guide

* [Retailer guide overview](retailer-guide/README.md)
* [Dashboard overview](retailer-guide/dashboard.md)
...
* [Scanner guide overview](scanner-guide/README.md)
* [Using the scanner app](scanner-guide/using-the-scanner.md)
* [Adding products in bulk](scanner-guide/adding-products-in-bulk.md)

## Shared topics

* [Order statuses explained](shared/order-statuses.md)
* [Payments](shared/payments.md)
* [Delivery and pickup](shared/delivery-and-pickup.md)
