...
If you browsed and added items **before** signing up, your cart should remain after login. If something looks missing, add items again and contact support if the problem continues.

## Profile

Under **Profile** you can update:
...
**Addresses** lets you save delivery locations:
...
All past and active orders live under **Orders**. Useful for:

- Re-ordering familiar items (browse shop again)
- Checking old bills
- Following up on issues

## Wishlist

Saved products per shop. Access from bottom navigation or profile.
...
For order-specific problems, use **order chat** first — the shop can resolve faster.
